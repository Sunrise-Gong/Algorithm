function solution(array, commands) {
    ...
    return commands.map(el => {
        return array
            .slice(el[0] - 1, el[1]) // 범위만큼 잘라내기 -> slice(인덱스를 기준으로 하기 때문에 첫번째 인자는 -1 해주었고, 두번째 인자는 해당 인덱스 전의 값까지만 나타내기 때문에 -1을 해주지 않음)
            .sort((a, b) => a - b)[el[2] - 1] // 오름차순으로 정렬하기 -> sort //el[2] 번째 있는 요소를 리턴해야 하니까 인덱스로 계산하려면 -1 을 해줘야 함. 
    })
}
